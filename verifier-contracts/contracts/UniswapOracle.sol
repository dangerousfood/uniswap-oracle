...
contract UniswapOracle {
	...
	function getAccountStorageRoot(address uniswapV2Pair, ProofData memory proofData, bytes32 blockHash) public view returns (bytes32 storageRootHash, uint256 blockNumber, uint256 blockTimestamp) {
		// console.logBytes(proofData.block);
		// console.logBytes(proofData.accountProofNodesRlp);
		// console.logBytes(proofData.reserveAndTimestampProofNodesRlp);
		// console.logBytes(proofData.priceAccumulatorProofNodesRlp);
	...
	function getPrice(IUniswapV2Pair uniswapV2Pair, address denominationToken, ProofData memory proofData, bytes32 blockHash) public view returns (uint256 price, uint256 blockNumber) {
		...
		// }
		return getPriceRaw(uniswapV2Pair, denominationTokenIs0, proofData, blockHash);
	}
	...
	function getPriceRaw(IUniswapV2Pair uniswapV2Pair, bool denominationTokenIs0, ProofData memory proofData, bytes32 blockHash) public view returns (uint256 price, uint256 blockNumber) {
		...
		uint256 historicPriceCumulativeLast;
		{
			...
			// console.logUint(historicPriceCumulativeLast);
